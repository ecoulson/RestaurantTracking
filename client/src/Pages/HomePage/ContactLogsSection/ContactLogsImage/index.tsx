    ...
    render() {
        return (
            <picture className="contact-us-image">
                ...
                <img alt="Our contact log application displayed on an IPhone that is on top of a stone on a green background" className="contact-us-image" src="./contactus.jpg"/>
            </picture>
        )
    }
}