...
class AddLocation extends React.Component<Props, IAddLocationState> {
    ...
    render() {
        return (
            <Wrapper>
                ...
                <Button onClick={this.addLocationToCart}>Add Location</Button>
            </Wrapper>
        )
    }
...
export default connector(AddLocation)