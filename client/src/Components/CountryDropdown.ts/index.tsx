...
export default class CountryDropdown extends React.Component<ICountryDropdownProps, ICountryDropdownState> {
        ...
        if (value) {
            this.setState({
                filteredCountries: this.state.countries.filter((country) => 
                    country.toLowerCase().includes(value.toLowerCase() as string))
            }, () => {
                this.props.onChange(this.state.filteredCountries[0]);
            })
        } else {
            this.props.onChange(this.state.filteredCountries[index.value]);
        }
    }
}